...
import static jonion.PeerConnectionManager.HOST_IP;
import static jonion.PeerConnectionManager.LISTEN_PORT;
...
public class PeerConnection {
    ...
    public void establishSharedSecret() {
        ...
        System.out.println("receivedJsonMessage:" + receivedJsonMessage);
